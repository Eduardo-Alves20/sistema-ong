...
<body>
    ...
    <div class="box">
        <form action="cadastrarpai.php" method="POST">
            <fieldset>
                ...
                <br>
                <div class="inputBox">
                    <input type="text" name="idfiho" id="idfilho" class="inputUser" required>
                    <label for="idfilho" class="labelInput">Nome do filho</label>
                </div>
                <br>
                
                <div class="inputBox">
                    <input type="text" name="cpf" id="senha" class="inputUser" required>
                ...
                <div class="inputBox">
                    <input type="text" name="data_nascimento" id="cidade" class="inputUser" >
                    <label for="cidade" class="labelInput">Data de Nascimento</label>
                </div> <br>
                <div class="inputBox">
                    <input type="text" name="cep" id="cidade" class="inputUser" >
                ...
                <input type="submit" name="cadastrarpai" id="submit-cadastrar">
            </fieldset>
        </form>
    </div>
</body>
