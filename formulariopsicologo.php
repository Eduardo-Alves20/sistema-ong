...
<body>
<div class="box">
        <form action="cadastrarpsicologo.php" method="POST">
            <fieldset>
                <legend><b>Fórmulário de Psicologo </b></legend>
                <br>
                ...
                <div class="inputBox">
                    <input type="number" name="crp" id="crp" class="inputUser" required>
                    <label for="crp" class="labelInput">CRP Medico</label>
                </div> 
                
                <br><br>
                
                <input type="submit" name="cadastrarpsicologo" id="submit">
            </fieldset>
        </form>
    </div>
</body>
